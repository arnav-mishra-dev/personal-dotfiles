local vars = require("hyprconfig/variables")
...
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -m region -z -t 500 -f $(date +'screenshot_%d%m%H%M%S.png') -o /home/arnav/Pictures/Screenshots"))
